...
- [`/IoT-Firmware`](https://github.com/notificator-project/IoT-Firmware)
  Open-source firmware for supported ESP32-based Notificator hardware.

- [`/public-api`](https://github.com/notificator-project/public-api)  
